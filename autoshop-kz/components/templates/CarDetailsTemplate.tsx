    ...
    <div className="min-h-screen bg-neutral-50 pb-24">
      ...
      <div className="bg-white border-b py-4">
        <Container>
          <Link 
            ...
            className="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors"
          >
      ...
      <Container className="py-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="sticky top-24 space-y-6">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <Button 
                      asChild 
                      variant="outline" 
                      className="w-full h-14 text-lg font-bold border-2 border-green-500 text-green-600 hover:bg-green-50"
                    >
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <div className="font-bold text-lg mb-2">{brand.identity.name}</div>
                <div className="text-neutral-500 text-sm mb-4">{brand.contact.address}</div>
                <div className="text-neutral-500 text-sm">{brand.contact.workingHours}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {similarCars.length > 0 && (
          <div className="mt-24">
            <h2 className="text-3xl font-bold mb-8">{t.similar_cars}</h2>
              ...
              {similarCars.map(similar => (
                <Link key={similar.id} href={locale === 'ru' ? `/ru/inventory/${similar.id}` : `/inventory/${similar.id}`}>
                  <div className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="p-5">
                      <h3 className="font-bold text-lg mb-1">{similar.make} {similar.model}</h3>
